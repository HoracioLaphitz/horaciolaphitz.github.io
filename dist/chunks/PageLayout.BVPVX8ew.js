...
const $$PageLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title, "description": description }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Navigation", Navigation, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Horacio/Desktop/proyectos/horaciolaphitz.github.io/src/presentation/components/layout/Navigation.tsx", "client:component-export": "default" })} ${maybeRenderHead()}<main class="pt-14 min-h-screen bg-skin-primary"> ${renderSlot($$result2, $$slots["default"])} </main> ` })}`;
}, "C:/Users/Horacio/Desktop/proyectos/horaciolaphitz.github.io/src/presentation/layouts/PageLayout.astro", void 0);
