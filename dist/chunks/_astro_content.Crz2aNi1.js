import { A as AstroError, U as UnknownContentCollectionError, n as createComponent, i as RenderUndefinedEntryError, B as unescapeHTML, w as renderTemplate, q as escape, x as renderUniqueStylesheet, u as renderScriptElement, o as createHeadAndContent, s as renderComponent } from './astro/server.CgJg2L5V.js';
import { z } from 'zod';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content.Cj35iXan.js');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets.B6sPodO3.js').then(n => n._);
...
export { DEFAULT_HASH_PROPS as D, VALID_SUPPORTED_FORMATS as V, DEFAULT_OUTPUT_FORMAT as a, getCollection as g, isRemotePath as i, joinPaths as j };
